...
class GACBlock(nn.Module):
    def __init__(self, in_planes, out_planes):
        ...
        self.cross_ver = GaborConv2d(in_planes, out_planes, kernel_size=(1, 3), padding=(0, 1), stride=1)
        self.cross_hor = GaborConv2d(in_planes, out_planes, kernel_size=(3, 1), padding=(1, 0), stride=1)
        self.bn = nn.BatchNorm2d(out_planes)
        self.relu = nn.ReLU(True)
