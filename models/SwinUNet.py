    ...
    def __init__(self, dim, input_resolution, window_size=8, shift_size=0):
        ...
        if self.shift_size:
            ...
            for h in (
                ...
                for w in (slice(0, -self.window_size[1]),
...
def main():
    ...
    dummy_input = torch.randn(1, 3, 768, 768)  # Ensure input size is 256x256
    model = SwinUNet(H=768, W=768, in_channels=3, C=64, num_class=2)
    print(model)
