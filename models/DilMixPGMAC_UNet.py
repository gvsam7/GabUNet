...
from models.ConvBlock import ChannelAttention, ACBlock, GACBlock, DilACBlock
from models.MixPool import MixPool


class DilMixPGMAC_UNet(nn.Module):
    def __init__(self, band_num, class_num):
        super(DilMixPGMAC_UNet, self).__init__()
        ...
        self.conv12 = nn.Sequential(
            MixPool(kernel_size=(2, 2), stride=(2, 2), padding=0, alpha=1),
