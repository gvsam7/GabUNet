...
class TransformerEncoder(nn.Module):
    def __init__(self, embedding_dim, head_num, mlp_dim, block_num):
        super().__init__()
...
class ViT(nn.Module):
    def __init__(self, img_dim, in_channels, embedding_dim, head_num, mlp_dim,
                 block_num, num_classes, patch_dim, classification=True):
        super().__init__()
...
class Encoder(nn.Module):
    def __init__(self, img_dim, in_channels, out_channels, head_num, mlp_dim, block_num, patch_dim, num_classes):
        ...
        self.vit = ViT(self.vit_img_dim, out_channels * 8, out_channels * 8,
                       head_num, mlp_dim, block_num, num_classes, patch_dim=1, classification=False)
...
class Decoder(nn.Module):
    def __init__(self, out_channels, num_classes):
        ...
        self.decoder1 = DecoderBottleneck(out_channels * 12, out_channels * 2)
