...
from models.ConvBlock import BatchNormReLU, DilResBlockMP, DilDecoder, GaborConv2d, DilResBlockAMP, \
    DualDomAttnDilResBlockMP, DualDomAttnDilDecoder
...
class DualDomAttnDilLogGabMPResUNet(nn.Module):
    def __init__(self, in_channels, num_class):
        super(DualDomAttnDilLogGabMPResUNet, self).__init__()
        ...
        self.res2 = DualDomAttnDilResBlockMP(64, 128, stride=2)
        self.res3 = DualDomAttnDilResBlockMP(128, 256, stride=2)
